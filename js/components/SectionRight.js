...
const OutputCode = () => {
    ...
    return (
        <p className={"console-output"} style={isCorrect ? {backgroundColor: "#F57F00"} : {backgroundColor: "#DB0049"}}>{isCorrect ? "Good job! The creature is gone!" : "Sorry, incorrect result. Try again."}</p>
    )
}
